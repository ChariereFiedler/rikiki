var s=Object.defineProperty;var n=Object.getOwnPropertyDescriptor;var c=(o,a,t,d)=>{for(var e=d>1?void 0:d?n(a,t):a,b=o.length-1,g;b>=0;b--)(g=o[b])&&(e=(d?g(a,t,e):g(e))||e);return d&&e&&s(a,t,e),e};import{LitElement as v,html as p,css as i}from"https://cdn.jsdelivr.net/npm/lit@3/+esm";import{customElement as k,property as f}from"https://cdn.jsdelivr.net/npm/lit@3/decorators.js/+esm";var r=class extends v{render(){return p`<slot></slot>`}};r.styles=i`
    :host {
  ...
  `,c([f({type:String})],r.prototype,"type",2),r=c([k("deck-badge")],r);export{r as DeckBadge};
