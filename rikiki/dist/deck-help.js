...
`;function d(e){let s=e.querySelector("#kb-overlay");if(s)return s;if(!e.querySelector(`style[${t}]`)){let a=document.createElement("style");a.setAttribute(t,"1"),a.textContent=o,e.appendChild(a)}let r=document.createElement("div");return r.innerHTML=n,s=r.firstElementChild,e.appendChild(s),s.addEventListener("click",()=>i(e.host)),s.querySelector(".kb-card")?.addEventListener("click",a=>a.stopPropagation()),s}function c(e){if(!e.shadowRoot)return;d(e.shadowRoot).classList.toggle("open")}function i(e){e.shadowRoot?.querySelector("#kb-overlay")?.classList.remove("open")}export{i as closeHelp,c as toggleHelp};
